"""
Django settings for BrightEye project.
...
SECRET_KEY = '6@ip6-1(=vsymlj^bt4ooo5l2y-r98$%-88gc#lib&8t$xf@uw'
...
WSGI_APPLICATION = 'BrightEye.wsgi.application'
...
BigTaskScript = '%s/%s'%(BASE_DIR,'backend/bigtask.py')
